var Arctic = {
    ...
    createMobileMenu: function(w) {
        ...
        if (w <= $tis.breakpoint && !$tis.mobMenuFlag) {
            ...
            $('#menu-mobile ul, #menu-mobile li, #menu-mobile a').each(function() {
    ...
    setMobileMenuFunctionality: function() {
        "use strict";
        $("#nav-mobile-holder > div").hover(function() {
    ...
    flexSlider: function() {
        ...
        if ($("#projects-slider").get(0)) {
            ...
            $("#projects-slider").resize(function() {});
        }
        if ($("#projects-slider-home2").get(0)) {
            ...
            $("#projects-slider-home2").resize(function() {});
        }
        ...
        if ($("#featured-slider").get(0)) {
            ...
            $("#featured-slider").resize(function() {});
        }
        if ($("#packages-slider").get(0)) {
            ...
            $("#packages-slider").resize(function() {});
        }
    },
    ...
    menuSearchInput: function() {
        "use strict";
        $('.sf-menu li#search').hover(function() {
    ...
    accordion: function() {
        ...
        $('.accordion > div, .faq > div').each(function() {
            var tis = $(this),
                state = false,
                ttl = $("h5", tis),
                plus = $(".plus-medium", tis),
                toggle = tis.children("div").not(".plus-medium").hide().css('height', 'auto').slideUp();
            tis.click(function() {
                state = !state;
                if (state) {
                    plus.html("-").css({
    ...
    contactForm: function() {
        ...
        $("#submit-form-contact").click(function(e) {
            ...
            if (name !== "" && re.test(email) && message !== "" && robotest === "") {
                $.ajax({
                    type: 'POST',
                    url: 'php/contact.php',
                    data: html,
    ...
    itemHover: function() {
        ...
        var $tis = this;
        var key;
        $("#projects-slider li, #projects-slider-home2 li, #packages-slider li, .portfolio-item").not(".portfolio4-item").hover(function(e) {
    ...
    createSitemap: function() {
        ...
        $(sitemap).html(nav);
        $('ul, li, a', sitemap).each(function() {
            $(this).removeAttr('style');
        });
        $('li#search', sitemap).remove();
